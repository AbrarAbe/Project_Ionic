    ...
    <ion-content class="home-page">
      <div class="main_content_div">
        ...
        <div class="content_div">
          ...
          <ion-grid>
            <br /><br /><br />
            <ion-row class="ion-padding" style="justify-content: space-between">
              ...
              <ion-col>
                <div
                  class="item-menu"
                  @click.prevent="toNavigate('inputujian')"
                >
                  <div>
                    <img
                      alt="project"
                      src="../assets/icons/matematika2.png"
                      style="width: 80px; height: 80px"
                    />
                  </div>
                  <h6 class="item-text">
                    Input Ujian Matematika <br />
                  </h6>
                </div>
              </ion-col>
              ...
              <ion-col>
                ...
                <div>
                  ...
                  <h6 class="item-text">
                    Input Ujian Bahasa Indonesia <br />
                  </h6>
                </div>
              </ion-col>
            </ion-row>
            ...
            <!--Tukang jahit-->
              ...
              <ion-col>
                ...
                >
                  <div>
                    <img
                      alt="project"
                      src="../assets/icons/fisika2.png"
                      style="width: 80px; height: 80px"
                    />
                  </div>
                  <h6 class="item-text">
                    Input Ujian Fisika <br /><span style="opacity: 0">s</span>
                  </h6>
                </div>
              </ion-col>
              ...
              <ion-col>
                ...
                <div>
                    <img
                      alt="project"
                      src="../assets/icons/biologi2.png"
                      style="width: 80px; height: 80px"
                    />
                  </div>
                  <h6 class="item-text">
                    Input Ujian Biologi <br /><span style="opacity: 0">s</span>
                  </h6>
                </div>
              </ion-col>
            </ion-row>
            ...
            <!--Tukang jahit-->
              ...
              <ion-col>
                ...
                >
                  <div>
                    <img
                      alt="project"
                      src="../assets/icons/kimia2.png"
                      style="width: 80px; height: 80px"
                    />
                  </div>
                  <h6 class="item-text">
                    Input Ujian Kimia <br /><span style="opacity: 0">s</span>
                  </h6>
                </div>
              </ion-col>
              ...
              <ion-col>
                ...
                <div>
                    <img
                      alt="project"
                      src="../assets/icons/inggris2.png"
                      style="width: 80px; height: 80px"
                    />
                  </div>
                  <h6 class="item-text">
                    Input Ujian Bahasa Inggris <br /><span style="opacity: 0">s</span>
                  </h6>
                </div>
              </ion-col>
            </ion-row>
